...
import { getTrends } from '@/lib/server/analytics/analytics.service'
import { TrendsQuerySchema } from '@/lib/server/analytics/analytics.schema'
...
export async function GET(request: Request) {
  try {
    ...
    const trends = await getTrends(prisma, userId, parsed.data)
