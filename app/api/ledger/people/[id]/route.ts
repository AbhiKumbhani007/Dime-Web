...
import {
  ...
  updatePerson,
  deletePerson,
} from '@/lib/server/ledger/ledger.service'
import {
...
export async function GET(request: Request, context: RouteContext) {
  try {
    ...
    try {
      const person = await getPerson(prisma, userId, paramsParsed.data.id)
...
export async function PATCH(request: Request, context: RouteContext) {
  try {
    ...
    const bodyParsed = UpdatePersonBodySchema.safeParse(body)
...
export async function DELETE(request: Request, context: RouteContext) {
  try {
    ...
    try {
      await deletePerson(prisma, userId, paramsParsed.data.id)
